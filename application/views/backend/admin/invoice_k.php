...
<?php foreach ($transaksi as $p) : ?>
    ...
    <head>
        <title>
            Super Laundry - Print Nota </title>
        <style type="text/css">
            html {
                font-family: "Verdana";
            }
    ...
    <body onload="window.print();">
        <div class="content">
            <div style="text-align:center;">
                <img style="display:inline-block;" height="58px" src="<?= base_url('assets/img/super.png') ?>">
            </div>
            <div class="title">
                Super Laundry<br>
                Perumahan BTN-Kolhua Kupang<br>
                www.super-laundry.com<br>
            </div>
